...
- KKS shares many common parts with KK/KKP, but it is not directly cross-compatible in most cases - you can't use DLC or plugins for one game in the other (with some exceptions of course).- You can configure many plugins by Pressing F1 and then "Plugin settings". You can also see most of the plugin hotkeys in this menu (and change them).
